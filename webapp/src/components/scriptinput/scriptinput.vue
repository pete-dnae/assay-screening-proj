            ...
            <div class="mw-100 col">
                ...
                <button type="button" @click="showPictures=!showPictures"
                 class="btn btn-secondary btn-lg btn-block">
                    <label v-if="showPictures">Pictures view <small>(click here to change to Interactive view)</small></label>
                    <label v-else>Interactive view <small>(click here to change to Pictures view)</small></label></button>
