...
class BatchReagentEntry():
    ...
    def load_db(self, reagents):
        """
        Provide reagents strings ,category (string) and  meta
        data they belong to like this:

            reagents = (
                ('reagent_1', 'category_A','foo'),
        ...
        categories updates.
        """
        for reagent_name, category_str,opaque_json_payload in reagents:
