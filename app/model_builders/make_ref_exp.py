...
from app.model_builders.reference_data import REFERENCE_REAGENT_CATEGORIES
...
class ReferenceExperiment():
    ...
    def create(self):
        ...
        for category in REFERENCE_REAGENT_CATEGORIES:
            ReagentCategoryModel.make(category)
