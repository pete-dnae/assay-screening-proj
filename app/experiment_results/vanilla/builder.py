...
from app.experiment_results.qpcr_results_summary import \
    make_vanilla_summary_idqpcr_datas
...
def make_master_table(well_constituents, qpcr_query, labchip_query):
    ...
    id_qpcr_datas = \
    make_vanilla_summary_idqpcr_datas(well_constituents, qpcr_results)
    master_table = \
    VanillaMasterTable.create_from_db(qpcr_plate_id, labchip_plate_id,
