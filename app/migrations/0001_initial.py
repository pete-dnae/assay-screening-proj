# Generated by Django 2.0.2 on 2018-02-15 11:49
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payload_type', models.CharField(choices=[('Dilution Factor', 'Dilution Factor'), ('HgDNA', 'HgDNA'), ('PA Primers', 'PA Primers'), ('ID Primers', 'ID Primers'), ('Strain', 'Strain')], max_length=15)),
