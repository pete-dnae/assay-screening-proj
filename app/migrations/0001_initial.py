# Generated by Django 2.0 on 2018-01-20 21:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payload_type', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='alloc_rule', to='app.Allocatable')),
            ],
            options={
