# Generated by Django 2.0 on 2018-02-12 21:35
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('payload_type', models.CharField(choices=[('Dilution Factor', 'Dilution Factor'), ('HgDNA', 'HgDNA'), ('PA Primers', 'PA Primers'), ('ID Primers', 'ID Primers'), ('Strain', 'Strain'), ('Strain Count', 'Strain Count'), ('Reagent', 'Reagent')], max_length=15)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('preferred_units', models.CharField(choices=[('X', 'X'), ('mM', 'mM'), ('mg/ml', 'mg/ml'), ('mM each', 'mM each'), ('microM each', 'microM each'), ('ng/ul', 'ng/ul'), ('cp/ul', 'cp/ul'), ('%', '%')], max_length=15)),
            ],
        ),
        migrations.CreateModel(
            name='CyclingPattern',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('concentration', models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='retgent', to='app.Concentration')),
            ],
        ),
        migrations.CreateModel(
            name='RuleList',
