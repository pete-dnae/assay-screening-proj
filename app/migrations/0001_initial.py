# Generated by Django 2.0 on 2018-01-11 11:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('rank_for_ordering', models.DecimalField(decimal_places=2, max_digits=8)),
                ('payload_type', models.CharField(choices=[('Strain', 'Strain'), ('Strain Count', 'Strain Count'), ('HgDNA', 'HgDNA'), ('PA Primers', 'PA Primers'), ('Dilution Factor', 'Dilution Factor'), ('ID Primers', 'ID Primers')], max_length=15)),
        ...
        migrations.AddField(
            ...
            field=models.ManyToManyField(to='app.AllocRule'),
        ),
    ]
